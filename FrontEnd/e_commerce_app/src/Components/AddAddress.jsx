  ...
  return (
    <div className='address'>
      <form onSubmit={addAddress} action="">
        ...
        <select value={address_type} onChange={(e) => { setAddress_Type(e.target.value) }} name="" id="">
          <option >Home</option>
          <option >Office</option>
        </select>
        <label htmlFor="">Building Name </label><input type="text" placeholder='Enter the Building Name ' required value={buildingName} onChange={(e) => { setBuildingName(e.target.value) }} />
        <label htmlFor="">Houseno </label><input type="text" placeholder='Enter the Houseno/floor' required value={house_number} onChange={(e) => { setHouse_Number(e.target.value) }} />
        <label htmlFor="">landMark</label> <input type="text" placeholder='Enter the landMark' required value={landMark} onChange={(e) => { setLandMark(e.target.value) }} />
        <label htmlFor="">PinCode</label><input type="text" placeholder='Enter the Pincode' required value={pincode} onChange={(e) => { setPincode(e.target.value) }} />
        ...
        <select value={country} onChange={(e) => { setCountry(e.target.value) }} name="" id="">
          {countryList.map((x) => {
            return (
              <>
                <option >{x.name}</option>
